              ...
              Expanded(
                ...
                child: Column(
                  children: [
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  // FadeInImage.assetNetwork(placeholderFit: BoxFit.scaleDown,fit: BoxFit.cover, placeholder: 'assets/images/loading_gif.gif',image: user != null ? user['photo'] : '' //CupertinoActivityIndicator()
                                )
                            ),
                    ...
                    CarouselSlider(
                      options: CarouselOptions(height: 120.0,enlargeCenterPage: true,enlargeFactor: 0.3, scrollDirection: Axis.horizontal,initialPage: 1, autoPlay: true,autoPlayCurve: Curves.fastOutSlowIn, autoPlayAnimationDuration: Duration(seconds: 2),autoPlayInterval: Duration(seconds: 6)),
                      items: [{'id':'Results', 'color': Colors.deepPurple, 'title': AppLocalizations.of(context)!.results, 'icon':Icons. bar_chart_outlined },{ 'id':'Elections','color': Colors.blueAccent, 'title': AppLocalizations.of(context)!.elections, 'icon':Icons.how_to_vote_outlined  },{'id':'Ongoing', 'color': Colors.deepPurpleAccent, 'title': AppLocalizations.of(context)!.ongoing_events, 'icon':Icons.poll_sharp},{'id':'Announcements', 'color': Colors.greenAccent, 'title':AppLocalizations.of(context)!.announcements,'icon':Icons.announcement_outlined  }, {'id':'Parties', 'color': Colors.orange, 'title': AppLocalizations.of(context)!.official_parties,'icon':Icons.people_alt_sharp }].map((i) {
                        return Builder(
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              padding:  const EdgeInsets.all(8.0),
                              child: Center(child: Text('Ongoing', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 15,color: status == 'ongoing' ? Colors.white : Colors.grey.shade600,),)),
                            ),
                          ),
                        ),
                          ...
                          builder: (context,snapshot){
                            if(snapshot.connectionState == ConnectionState.waiting){
                              ...
                              return ListView.builder( itemCount: electionProvider.elections.length ,itemBuilder: (context, index){
                                  ...
                                  return  Padding(
                                    ...
                                    child: Material(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            color: Color(0xfffafcfb), //const Color(0XFFf5f7f5),
                                            ...
                                            children: [
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text("Date: ${DateFormat('dd MMMM yyyy').format(DateTime.parse(elections.startDate.toString()))}", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Colors.black),),

                                                ],
                                              ),

                                              if(formatDate(elections.startDate) == DateFormat('d MMMM yyyy').format(DateTime.parse( DateTime.now().toString())))
                                              InkWell(
                                                onTap: (){
                                ...
                                }// && elections.status!.toLowerCase() == 'in progress'
                                              ...
                                              children: [
                                                Column(
                                                  ...
                                                  crossAxisAlignment: CrossAxisAlignment
                                                      .start,
                                                  children: [
                                                    //"Presidential Elections 2024  10 March 2024"
                                                    Text("${elections
                                                        .title} ${DateFormat(
                                                        'yyyy').format(
                                                        DateTime.parse(
                                                    ...
                                                    Text("Status: ${elections
                                                        .status?.toUpperCase()}" , style: TextStyle(fontStyle: FontStyle.italic, color: Colors.grey.shade600, fontWeight: FontWeight.w500),)
                                                  ],
                                                ),
                                            InkWell(
                                              onTap: (){
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            Text('${announcementProvider.postList[index]['content']?.split(' ').take(15).join(' ') ?? ''}...', textAlign: TextAlign.justify , style: TextStyle(fontWeight: FontWeight.w500, color: Colors.black),),
