...
//      isConnected = false;
//      print('Not connected');
//      ScaffoldMessenger.of(context).showMaterialBanner( MaterialBanner(backgroundColor: Colors.red ,content: Text("Check Internet Connection..." ,style: headline3, ), actions: const [ CupertinoActivityIndicator(color: Colors.black)]));
...
//       case ConnectionState.waiting: // Handle ConnectionState.waiting
